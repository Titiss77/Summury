 ...
 *
 * @see ArrayHelperDotKeyExistsTest
 * @see ArrayHelperRecursiveDiffTest
 * @see ArrayHelperSortValuesByNaturalTest
 */
final class ArrayHelper
{
     ...
     * @param null|int|string                   $sortByIndex
     */
    ...
    private static function arraySearchDot(array $indexes, array $array)
    {
        ...
        if ('*' === $currentIndex) {
            ...
            $answer = array_filter($answer, static fn ($value): bool => null !== $value);

            if ([] !== $answer) {
                // If array only has one element, we return that element for BC.
                return 1 === count($answer) ? current($answer) : $answer;
            }
