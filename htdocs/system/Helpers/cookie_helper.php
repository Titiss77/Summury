...
if (!function_exists('set_cookie')) {
     ...
     * @param null|bool           $secure   True makes the cookie secure
     * @param null|bool           $httpOnly True makes the cookie accessible via http(s) only (no javascript)
     * @param null|string         $sameSite The cookie SameSite value
     *
     * @see Response::setCookie()
     */
    function set_cookie(
        $name,
        string $value = '',
...
if (!function_exists('get_cookie')) {
     ...
     *
     * @param string      $index
     * @param null|string $prefix Cookie name prefix.
     *                            '': the prefix in Config\Cookie
     *                            null: no prefix
     *
     * @return null|array|string
     *
     * @see IncomingRequest::getCookie()
     */
