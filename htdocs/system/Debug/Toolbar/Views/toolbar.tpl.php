...
<script id="toolbar_js">
    var ciSiteURL = "<?php echo rtrim(site_url(), '/'); ?>"
    ...
    <div class="toolbar">
        ...
        <?php foreach ($collectors as $c) { ?>
            <?php if (!$c['isEmpty'] && ($c['hasTabContent'] || $c['hasLabel'])) { ?>
                <span class="ci-label">
                    <a data-tab="ci-<?php echo $c['titleSafe']; ?>">
                        <img src="<?php echo $c['icon']; ?>">
                        <span class="hide-sm">
                            <?php echo $c['title']; ?>
                            <?php if (null !== $c['badgeValue']) { ?>
    ...
    <div id="ci-vars" class="tab">
        ...
        <?php if (isset($vars['varData'])) { ?>
            <?php foreach ($vars['varData'] as $heading => $items) { ?>
                ...
                <a class="debug-bar-vars" data-toggle="datatable" data-table="<?php echo strtolower(str_replace(' ', '-', $heading)); ?>">
