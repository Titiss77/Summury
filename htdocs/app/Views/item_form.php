        ...
        <div class="form-group row">
            ...
            <div class="col-half">
                ...
                <select id="sous_categorie_select" name="sous_categorie_select" class="form-control" onchange="toggleNewSubCategory()">
                    ...
                    <?php } ?>
                    <option value="__NEW__" style="font-weight: bold; color: var(--primary);">+ Créer une nouvelle...</option>
                </select>
        ...
        <div class="form-group row">
            <div class="col-half">
                ...
                <select id="status" name="status" class="form-control">
                    ...
                    <option value="Terminé" <?php echo 'Terminé' == $currentStatus ? 'selected' : ''; ?>>Terminé</option>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <div style="flex-shrink: 0; width: 80px; height: 120px; border: 2px dashed var(--border-color); border-radius: var(--radius-md); overflow: hidden; display: flex; align-items: center; justify-content: center; background: var(--bg-body); transition: var(--transition);position: relative; top: -40px;">
                    <img id="img-preview" src="<?php echo htmlspecialchars($item->image ?? ''); ?>" alt="Aperçu" style="width: 100%; height: 100%; object-fit: cover; display: <?php echo !empty($item->image) ? 'block' : 'none'; ?>;">
                    <span id="img-placeholder" style="color: var(--text-muted); font-size: 0.8rem; text-align: center; padding: 5px; display: <?php echo empty($item->image) ? 'block' : 'none'; ?>;">Aperçu</span>
                </div>
            </div>
        </div>
